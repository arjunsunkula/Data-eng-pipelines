...
project_id = 'lateral-rider-456109-s6'
dataset_id = 'initial_dataset'
transform_dataset_id = 'transformed_dataset'
reporting_dataset_id = 'report_dataset'
...
with DAG(
    ...
    check_file_exists = GCSObjectExistenceSensor(
        ...
        bucket='airflow-bucket01',  # Replace with your bucket name
